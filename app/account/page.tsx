              ...
              {isPaid && (
                <>
                  ...
                  <div>
                    ...
                    <p className="text-white capitalize">{profile.subscription_status}</p>
                  </div>
...
{usage ? (
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between items-baseline mb-1">
                    <p className="text-sm text-gray-400">Words Generated</p>
                ...
                <div>
                  <div className="flex justify-between items-baseline mb-1">
                    <p className="text-sm text-gray-400">PDF Redesigns</p>
                    <p className="text-white font-medium">
                ...
                <div>
                  <div className="flex justify-between items-baseline mb-1">
                    ...
                    <p className="text-white font-medium">
                      ...
                      <span className="text-gray-500 text-sm ml-1">(tracked)</span>
                    </p>
                  </div>
            ...
            <div className="space-y-3">
              {isFreeTrial && (
                <button
                  ...
                  className="block w-full py-3 px-4 bg-white text-black text-center font-medium rounded-lg hover:bg-gray-200 transition-colors"
                >
              ...
              {isPaid && (
                <>
                  <button
                    ...
                    className="block w-full py-3 px-4 bg-[#2a2a2a] text-white text-center font-medium rounded-lg hover:bg-[#333333] transition-colors border border-[#404040] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
        ...
        {/* Feature Access */}
        <div className="mt-8 bg-[#171717] border border-[#2a2a2a] rounded-2xl p-6">
      ...
      {showCancelModal && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl p-6 max-w-md w-full">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3 px-4 bg-[#2a2a2a] text-white text-center font-medium rounded-lg hover:bg-[#333333] transition-colors border border-[#404040] disabled:opacity-50"
              >
                Keep Subscription
              </button>
              <button
      ...
      {showUpgradeModal && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl p-6 max-w-2xl w-full">
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="text-2xl font-semibold mb-2">Choose Your Plan</h3>
                <p className="text-gray-400">Select a billing interval for the Educator Plan</p>
              </div>
              <button
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <button
                ...
                className="bg-[#2a2a2a] border border-[#404040] rounded-xl p-6 text-left hover:border-white transition-all group"
              >
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h4 className="text-lg font-semibold group-hover:text-white transition-colors">Monthly</h4>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-gray-300">All differentiation features</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <button
                ...
                className="bg-[#2a2a2a] border-2 border-green-500 rounded-xl p-6 text-left hover:border-green-400 transition-all group relative"
              >
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h4 className="text-lg font-semibold group-hover:text-white transition-colors">Annual</h4>
